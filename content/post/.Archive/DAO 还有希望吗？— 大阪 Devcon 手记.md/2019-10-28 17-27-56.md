...
如果是**更加灵活的应用场景呢？特定时期特定人群出于某个特定目标，临时集成的组织，能否用 DAO 来实现？这些人里面，有一些是领导者/发起者，有一些是有兴趣参与但是不愿意做太多规划的人。此时一个有一定治理功能，但规则大部分由组织领导制定的自治组织就出现了。
...
扫码下图，加入本期快闪群参与内容讨论，7 天内自动解散。超过 100 人加入请联系微